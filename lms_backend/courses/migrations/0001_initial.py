# Generated by Django 6.0.7 on 2026-07-11 15:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ai_script', models.TextField(help_text='The script for AI video generation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.OneToOneField(limit_choices_to={'is_instructor': True}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
